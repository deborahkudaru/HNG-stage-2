      ...
      <div className="pl-14 pt-8 font-popins">
        <div className="flex gap-16">
          ...
          <div className="font-popins">
            <h2 className="text-arrival mb-7">Payment Information</h2>
            <h4 className="font-popins font-semibold text-2xl mb-2">Mode of Payment</h4>
            <div className="mb-2 flex gap-3" >
              <input type="checkbox" name="" id="" className="bg-generalColor checked:bg-generalColor"/>
            ...
            <h4 className="font-popins font-semibold text-2xl mt-10">Enter Card Details</h4>
            ...
            <div className="flex flex-col text-xl mt-3">
              ...
              <input type="text" className="border border-borderColor w-input bg-generalColor rounded-lg px-2" />
            </div>
            ...
            <button className="rounded-lg py-3 px-6 mt-5 bg-customOrange text-white font-popins text-xl">Continue</button>
          </div>
        </div>
      </div>
    </div>
